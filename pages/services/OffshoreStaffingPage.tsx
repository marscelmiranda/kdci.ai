          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-stretch mt-8">
            ...
            <div className="text-left flex flex-col py-2">
              <h1 className="text-5xl md:text-7xl lg:text-7xl font-heading font-bold text-white mb-6 md:mb-8 tracking-tight leading-[1.1] drop-shadow-2xl">
                <span className="text-[#E61739]">Outsource to the Philippines </span><span className="text-white">for Scaling Teams</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-[#1D1D1F] tracking-tight leading-tight mb-4">
              The world's leading provider of outsourced teams.
            </h2>
            <p className="text-slate-500 text-base font-medium leading-relaxed max-w-5xl mx-auto">
      ...
      <section className="py-20 bg-[#F5F5F7]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16">
            ...
            <p className="text-slate-500 font-medium max-w-sm text-[15px]">Every engagement below started with a discovery call and grew into a long-term partnership. Outsource an offshore team from the Philippines today!</p>
          </div>
