...
import IMG_HERO_MEETING from '@/attached_assets/Gemini_Generated_Image_qrq21iqrq21iqrq2_1779320544394.png';
...
export const AIWorkforcePage = ({ setView }: { setView: (v: ViewType) => void }) => {
