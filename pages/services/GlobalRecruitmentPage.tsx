            ...
            <div className="">
              ...
              <div className="space-y-8">
                {[
                  ...
                  { title: "90-Day Placement Guarantee", desc: "Every outsourced hire is backed by a 90-day replacement guarantee. If it doesn't work out, we re-source at no additional cost— zero risk to you.", icon: Award },
                ].map((item, idx) => (
