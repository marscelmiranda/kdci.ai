            ...
            {submitted ? (
              ...
              <>
                <div className="mb-8">
                  ...
                  <p className="text-white/40 font-medium text-[13px]">Every long-term offshore staffing enggement begins with a discover call. Tell us what you need, and we'll match you with top Philippine professionals.</p>
                </div>
