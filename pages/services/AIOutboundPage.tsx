      ...
      <section className="py-20 bg-[#F5F5F7]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900">Most outbound programs stall because they're built on guesswork, not real prospect data.</h2>
          </div>
      ...
      <section className="py-32 bg-[#080808] relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Target,       title: "ICP Definition & Buyer Persona Mapping", desc: "ICP research, enrichment, AI-personalized sequences, LinkedIn outreach, meeting booking, and pipeline reporting run end-to-end by our team." },
