...
import { ArrowRight, ShoppingCart, Users, BarChart3, Globe, Star, Package, RefreshCw, Tags, MessageSquare, Shirt, Smartphone, Home, Gift, BrainCircuit, CheckCircle2, Store, Users2, Activity, Settings2 } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_RETAIL_HERO as HERO_IMG, IMG_RETAIL_TEAM as TEAM_IMG } from '../../data';

export const RetailPage = ({ setView }: { setView: (v: ViewType) => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-managed retail operations and customer experience support" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Retail Operations" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Omnichannel</span><br/>
            <span className="text-[#E61739]">Retail Ops.</span>
          </h1>
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Unified support, inventory management, and catalog operations for modern retail brands. Powered by AI for 24/7 global reach.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Order Accuracy</p>
            </div>
            <div className="text-center md:text-left">
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Retail Capabilities</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">Scalable backend operations that keep your store running smoothly during peak seasons.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Users, title: "Customer Care", desc: "Handling sizing queries, returns, and order tracking across email, chat, and social." },
              { icon: Package, title: "Order Processing", desc: "Managing fulfillment exceptions, fraud checks, and shipping coordination." },
              { icon: RefreshCw, title: "Returns Management", desc: "Processing RMAs efficiently to restock items faster and retain revenue." },
              { icon: Tags, title: "Catalog Management", desc: "Updating SKUs, product descriptions, prices, and imagery across all channels." },
              { icon: Star, title: "Loyalty Admin", desc: "Managing rewards points, VIP tier adjustments, and customer segments." },
              { icon: MessageSquare, title: "Live Chat Sales", desc: "Proactive engagement to convert browsing visitors into buyers." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Inventory Visibility</h4>
               <p className="text-white/60 font-medium">Real-time stock level monitoring and reorder coordination to prevent stockouts during spikes.</p>
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               ...
               { icon: Home, name: "Home Goods" },
               { icon: Gift, name: "Beauty" },
               { icon: Store, name: "Luxury" }
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Elastic Deployment.</h2>
            <p className="text-slate-500 text-xl font-medium">Scale up for Black Friday, scale down for Q1.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Integration', desc: 'Connecting to Shopify, Gorgias, and your ERP.', icon: Settings2 },
              { step: '02', title: 'Training', desc: 'Agents learn your brand voice and product catalog.', icon: Users2 },
              { step: '03', title: 'Scale', desc: 'Deploying the pod with 24/7 coverage capability.', icon: Activity },
              { step: '04', title: 'Auto-QA', desc: 'AI monitoring ensures quality across every interaction.', icon: CheckCircle2 }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Commerce <br/><span className="text-[#E61739]">Automated.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    We deploy AI agents to handle the repetitive "Where is my order?" tickets, freeing up your human team to drive sales and solve complex issues.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "Smart Routing", desc: "Directing VIP customers to senior agents instantly." },
                       { title: "Order Status Bots", desc: "Automated lookups for tracking inquiries, resolving 40% of tickets." },
                       { title: "Sentiment Analysis", desc: "Flagging negative reviews or angry customers for immediate attention." },
                       { title: "Catalog Auto-Tagging", desc: "AI visual recognition to tag product attributes for better search." }
                     ].map((feat, idx) => (
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#E61739] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     <div className="text-3xl font-black mb-1 text-center">40%</div>
                     <div className="text-[10px] font-black uppercase tracking-widest opacity-80">Ticket Deflection</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Flexible Retail Plans.</h2>
            <p className="text-slate-500 text-xl font-medium max-w-3xl mx-auto mb-10">Scaling your retail operations without the headcount friction.</p>
          ...
          {pricingModel === 'outcomes' ? (
            <div className="grid md:grid-cols-3 gap-6 items-start animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { 
                  name: "Peak Season Support", 
                  price: "$2,800", 
                  desc: "Scalable CS team for holidays.", 
                  features: ["Rapid ramp-up", "24/7 coverage options", "Crisis management", "Order backlog clearing"], 
                  highlight: false 
                },
                { 
                  name: "Omnichannel Support", 
                  price: "Custom", 
                  desc: "Unified customer care unit.", 
                  features: ["Chat + Email + Social", "Dedicated Team Lead", "Integrated AI Triage", "CSAT Optimization"], 
                  highlight: true, 
                  badge: "Full Cycle" 
                },
                { 
                  ...
                  price: "$1,900", 
                  desc: "Stock monitoring & POs.", 
                  features: ["Daily stock checks", "Reorder coordination", "Supplier communication", "Discrepancy reporting"], 
                  highlight: false 
                }
              ].map((plan, i) => (
                <div key={i} className={`p-10 rounded-[3.5rem] relative transition-all ${plan.highlight ? 'bg-slate-900 text-white shadow-2xl scale-105 border-0' : 'bg-white border border-slate-100 shadow-sm hover:shadow-xl'}`}>
                  ...
                  <button onClick={() => setView('contact')} className={`w-full py-4 rounded-[2rem] font-bold text-lg transition-all ${plan.highlight ? 'bg-[#E61739] text-white hover:bg-[#c51431] shadow-xl' : 'bg-slate-900 text-white hover:bg-black'}`}>
                    {plan.name === "Omnichannel Support" ? "Request Custom Quote" : "Request Plan"}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                ...
                { role: "Store Manager", price: "$2,400", focus: "Ops", focusIcon: Store, desc: "Overseeing daily store operations and team performance." }
              ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E61739] shadow-sm"><Globe size={24} /></div>
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Expanding Globally?</h4>
                   <p className="text-sm text-slate-500 font-medium">We offer multilingual support to help you enter new markets.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: Star, title: "Peak Season Ready", desc: "Rapidly ramp up teams for Black Friday/Cyber Monday." },
              { icon: Shirt, title: "Brand Voice Experts", desc: "We adopt your brand's unique tone and style guide perfectly." },
              { icon: Globe, title: "Platform Agnostic", desc: "Experts in Shopify, Magento, BigCommerce, and Salesforce." },
              { icon: Users, title: "Retention Focused", desc: "Turning support interactions into loyalty opportunities." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI retail support team delivering AI-powered operations and customer experience" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Scale Your <br/><span className="text-shine-red">Retail Operations.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our retail solutions architects.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#E61739] text-white rounded-[2rem] font-bold text-xl hover:bg-[#c51431] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request Retail Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
