    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-managed fintech operations and financial services support" className="w-full h-full object-cover opacity-20 object-center" />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#ad1457] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     <div className="text-3xl font-black mb-1 text-center">100%</div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI fintech support team delivering AI-managed financial services operations" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
