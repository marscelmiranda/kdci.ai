...
import { ArrowRight, Smartphone, Settings, Star, Bug, BookOpen, Users, Globe, BrainCircuit, CheckCircle2, MessageSquare, Zap, Activity, Gamepad2, Settings2 } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_CON_TECH_HERO as HERO_IMG, IMG_CON_TECH_TEAM as TEAM_IMG } from '../../data';

export const ConsumerTechPage = ({ setView }: { setView: (v: ViewType) => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-powered consumer technology support and help desk operations" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Consumer Tech" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Support Your</span><br/>
            <span className="text-[#E61739]">Users 24/7.</span>
          </h1>
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Technical support and community management for hardware, apps, and connected devices.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">4.8/5</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Avg CSAT</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">&lt;1m</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Response Time</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">Tier 3</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Resolution</p>
            </div>
            <div className="text-center md:text-left">
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Tech Services</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">Expert help for your users, from hardware setup to software bugs.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Settings, title: "Product Support", desc: "Troubleshooting hardware issues, connectivity problems, and setup guides." },
              { icon: Star, title: "App Reviews", desc: "Monitoring and responding to App Store and Google Play reviews." },
              { icon: Bug, title: "Beta Testing Mgmt", desc: "Coordinating beta user groups, gathering feedback, and reporting bugs." },
              { icon: BookOpen, title: "Knowledge Base", desc: "Creating and maintaining self-help articles, FAQs, and video guides." },
              { icon: Users, title: "Community Mgmt", desc: "Engaging with users on Discord, Reddit, and social forums." },
              { icon: MessageSquare, title: "In-App Support", desc: "Real-time chat support embedded directly within your mobile or web app." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Tech-Savvy Agents</h4>
               <p className="text-white/60 font-medium">We hire agents who are passionate about technology and can speak your users' language.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               { icon: Settings, name: "Hardware Startups" },
               { icon: Smartphone, name: "SaaS Apps" },
               { icon: Gamepad2, name: "Gaming Studios" },
               { icon: Globe, name: "IoT Brands" },
               { icon: Activity, name: "Wearables" }
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Launch Protocol.</h2>
            <p className="text-slate-500 text-xl font-medium">Getting your support team up to speed.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Product Dive', desc: 'Our team studies your product and documentation.', icon: Smartphone },
              { step: '02', title: 'Tool Sync', desc: 'Integration with Zendesk, Intercom, or Jira.', icon: Settings2 },
              { step: '03', title: 'Launch', desc: 'Agents go live with tiered support escalation.', icon: Zap },
              { step: '04', title: 'Feedback Loop', desc: 'Regular reporting on bugs and feature requests.', icon: MessageSquare }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Smart <br/><span className="text-[#E61739]">Support.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    AI helps us resolve common issues instantly and surface critical bugs to your engineering team faster.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "Smart Triage", desc: "Automatically routing technical issues to Tier 2/3 agents." },
                       { title: "Deflection Bots", desc: "Solving simple setup and FAQ queries without human intervention." },
                       { title: "Sentiment Trends", desc: "Tracking user happiness after feature releases or updates." },
                       { title: "Auto-Responses", desc: "Instant acknowledgement and suggested fixes based on keywords." }
                     ].map((feat, idx) => (
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#ad1457] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     ...
                     <div className="text-[10px] font-black uppercase tracking-widest opacity-80">Bug Triaging</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Flexible Tech Plans.</h2>
            <p className="text-slate-500 text-xl font-medium max-w-3xl mx-auto mb-10">Scalable support options for high-growth consumer products.</p>
          ...
          {pricingModel === 'outcomes' ? (
            <div className="grid md:grid-cols-3 gap-6 items-start animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { 
                  ...
                  price: "$2,800", 
                  desc: "Rapid product launch coverage.", 
                  features: ["Surge staffing", "24/7 coverage", "Launch playbook", "Real-time feedback loop"], 
                  highlight: false 
                },
                { 
                  name: "Managed Support Unit", 
                  price: "Custom", 
                  desc: "Full CX operations + QA.", 
                  features: ["Dedicated Team Lead", "Omnichannel Support", "QA & Training", "Performance Analytics"], 
                  highlight: true, 
                  badge: "Full Coverage" 
                },
                { 
                  ...
                  price: "$2,400", 
                  desc: "Engagement & Moderation.", 
                  features: ["Discord/Reddit Mgmt", "24/7 Moderation", "User Sentiment Analysis", "Event Coordination"], 
                  highlight: false 
                }
              ].map((plan, i) => (
                <div key={i} className={`p-10 rounded-[3.5rem] relative transition-all ${plan.highlight ? 'bg-slate-900 text-white shadow-2xl scale-105 border-0' : 'bg-white border border-slate-100 shadow-sm hover:shadow-xl'}`}>
                  ...
                  <button onClick={() => setView('contact')} className={`w-full py-4 rounded-[2rem] font-bold text-lg transition-all ${plan.highlight ? 'bg-[#ad1457] text-white hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] shadow-xl' : 'bg-slate-900 text-white hover:bg-black'}`}>
                    {plan.name === "Managed Support Unit" ? "Request Custom Quote" : "Request Plan"}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { role: "Tech Support Agent", price: "$1,900", focus: "T1/T2", focusIcon: Settings, desc: "Handling setup, troubleshooting, and general inquiries." },
                { role: "Community Mgr", price: "$2,100", focus: "Social", focusIcon: Users, desc: "Managing Discord, Reddit, and forums." },
                { role: "QA Tester", price: "$2,200", focus: "Quality", focusIcon: Bug, desc: "Manual testing and bug reporting for apps/web." },
                { role: "Knowledge Spec", price: "$1,800", focus: "Content", focusIcon: BookOpen, desc: "Writing help articles and creating video guides." }
              ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E61739] shadow-sm"><Settings size={24} /></div>
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Need Tier 3 Support?</h4>
                   <p className="text-sm text-slate-500 font-medium">Dedicated engineers for complex issue resolution.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: Settings, title: "Tech Enthusiasts", desc: "We hire agents who genuinely love gadgets and software." },
              { icon: Zap, title: "Agile Teams", desc: "Ready to pivot with your product updates and launches." },
              { icon: Globe, title: "Global Reach", desc: "Support users in any timezone and multiple languages." },
              { icon: Bug, title: "Product Loop", desc: "Structured feedback to help you build a better product." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI consumer tech support team delivering AI-powered service solutions" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Scale Your <br/><span className="text-shine-red">Tech Support.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our consumer tech support specialists.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#ad1457] text-white rounded-[2rem] font-bold text-xl hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request Tech Support Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
