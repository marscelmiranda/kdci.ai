...
import { ArrowRight, ShieldCheck, Phone, FileText, BarChart3, Users, Building, Lock, BrainCircuit, CheckCircle2, FileCheck, Landmark, Umbrella, Car, Home, Activity, Settings2, UserCheck, Handshake, Zap, Smartphone } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_INSURANCE_HERO as HERO_IMG, IMG_INSURANCE_TEAM as TEAM_IMG } from '../../data';

export const InsurancePage = ({ setView }: { setView: (v: ViewType) => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-managed insurance operations and policyholder support" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Insurance Operations" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Digital-First</span><br/>
            <span className="text-[#E61739]">Insurance Ops.</span>
          </h1>
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Accelerate claims processing and policy administration with AI-augmented offshore teams for carriers and InsurTechs.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            ...
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">3x</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Faster Claims</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">24/7</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">FNOL Support</p>
            </div>
            <div className="text-center md:text-left">
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Insurance Services</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">Scalable back-office and customer-facing operations for the modern insurance stack.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: FileCheck, title: "Claims Processing", desc: "First notice of loss (FNOL) intake, documentation review, and adjudication support." },
              { icon: FileText, title: "Policy Admin", desc: "Managing renewals, endorsements, and policy issuance workflows." },
              { icon: UserCheck, title: "Underwriting Support", desc: "Data gathering, risk assessment prep, and application scrubbing for underwriters." },
              { icon: Phone, title: "Customer Support", desc: "Omnichannel support for policyholders regarding coverage and billing." },
              { icon: Activity, title: "Broker Support", desc: "Assisting agents and brokers with quotes, commissions, and compliance docs." },
              { icon: ShieldCheck, title: "Fraud Detection", desc: "Reviewing flagged claims and suspicious activity patterns." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Licensed & Trained</h4>
               <p className="text-white/60 font-medium">We can source staff with insurance backgrounds and support licensing requirements for specific regions.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               { icon: Landmark, name: "Carriers" },
               { icon: Umbrella, name: "MGAs" },
               { icon: Smartphone, name: "InsurTechs" },
               { icon: Handshake, name: "Brokerages" },
               { icon: Car, name: "TPA Firms" }
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Operations Roadmap.</h2>
            <p className="text-slate-500 text-xl font-medium">Securely deploying your insurance operations team.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Security Audit', desc: 'Ensuring data handling meets SOC-2 and HIPAA standards.', icon: Lock },
              { step: '02', title: 'System Sync', desc: 'Integration with Guidewire, Duck Creek, or custom admin panels.', icon: Settings2 },
              { step: '03', title: 'Product Training', desc: 'Deep dive into your policy types and coverage details.', icon: FileText },
              { step: '04', title: 'Scale Up', desc: 'Ramping team size for enrollment periods or catastrophe response.', icon: BarChart3 }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Automated <br/><span className="text-[#E61739]">Claims.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    We use AI to speed up the claims lifecycle, from document ingestion to fraud detection.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "Doc Ingestion", desc: "AI OCR automatically extracts data from PDF claims and police reports." },
                       { title: "Fraud Flags", desc: "Algorithms detect patterns indicative of fraudulent activity for review." },
                       { title: "Chatbot FNOL", desc: "Automated First Notice of Loss intake via chat or app." },
                       { title: "Policy Q&A", desc: "AI assistants helping agents quickly find coverage details in policy docs." }
                     ].map((feat, idx) => (
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#ad1457] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     ...
                     <div className="text-[10px] font-black uppercase tracking-widest opacity-80">Fraud Detection</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-xl font-medium max-w-3xl mx-auto mb-10">Cost-effective roles for insurance operations.</p>
          ...
          {pricingModel === 'outcomes' ? (
            <div className="grid md:grid-cols-3 gap-6 items-start animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { 
                  name: "FNOL Unit", 
                  price: "$2,400", 
                  desc: "24/7 Intake Coverage.", 
                  features: ["First Notice of Loss", "Emergency Dispatch", "Initial Documentation", "SLA Monitoring"], 
                  highlight: false 
                },
                { 
                  name: "Claims Ops", 
                  ...
                  features: ["Dedicated Adjuster Support", "Fraud Screening", "Settlement Admin", "Compliance Audit"], 
                  highlight: true, 
                  badge: "Full Cycle" 
                },
                { 
                  name: "Policy Admin", 
                  price: "$1,900", 
                  desc: "Back-office efficiency.", 
                  features: ["Renewals Processing", "Endorsement Entry", "COI Issuance", "Data Validation"], 
                  highlight: false 
                }
              ].map((plan, i) => (
                <div key={i} className={`p-10 rounded-[3.5rem] relative transition-all ${plan.highlight ? 'bg-slate-900 text-white shadow-2xl scale-105 border-0' : 'bg-white border border-slate-100 shadow-sm hover:shadow-xl'}`}>
                  ...
                  <button onClick={() => setView('contact')} className={`w-full py-4 rounded-[2rem] font-bold text-lg transition-all ${plan.highlight ? 'bg-[#ad1457] text-white hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] shadow-xl' : 'bg-slate-900 text-white hover:bg-black'}`}>
                    {plan.name === "Claims Ops" ? "Request Custom Quote" : "Request Plan"}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { role: "Claims Assistant", price: "$2,000", focus: "Claims", focusIcon: FileCheck, desc: "Supporting adjusters with documentation and follow-ups." },
                { role: "Underwriting Asst", price: "$2,200", focus: "Risk", focusIcon: UserCheck, desc: "Gathering data and prepping files for underwriting review." },
                { role: "Policy Tech", price: "$1,800", focus: "Admin", focusIcon: FileText, desc: "Data entry for policy issuance and changes." },
                { role: "Support Agent", price: "$1,900", focus: "Service", focusIcon: Phone, desc: "Handling billing and general policy inquiries." }
              ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E61739] shadow-sm"><Umbrella size={24} /></div>
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Need Licensed Staff?</h4>
                   <p className="text-sm text-slate-500 font-medium">We can recruit staff with specific insurance designations.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: ShieldCheck, title: "Data Security", desc: "Rigorous protocols to protect sensitive policyholder data." },
              { icon: Activity, title: "Speed to Bind", desc: "Operations focused on reducing turnaround times." },
              { icon: Zap, title: "Catastrophe Ready", desc: "Scalable teams for storm seasons and high claim volumes." },
              { icon: Settings2, title: "Platform Agnostic", desc: "Experience with Guidewire, Duck Creek, and Applied Systems." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI insurance industry team delivering AI-managed claims and policyholder support" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Scale Your <br/><span className="text-shine-red">Insurance Ops.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our insurance operations specialists.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#ad1457] text-white rounded-[2rem] font-bold text-xl hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request Insurance Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
