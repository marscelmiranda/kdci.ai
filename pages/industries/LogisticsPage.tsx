...
import { ArrowRight, Truck, Phone, FileText, Globe, CheckCircle2, MapPin, ClipboardList, Navigation, Box, Anchor, Container, BrainCircuit, Activity, Settings2, Users } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_LOGISTICS_HERO as HERO_IMG, IMG_LOGISTICS_TEAM as TEAM_IMG } from '../../data';

export const LogisticsPage = ({ setView }: { setView: (v: ViewType) => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-managed logistics and supply chain operations support" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Logistics & Supply Chain" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Supply Chain</span><br/>
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Back-office efficiency and dispatch support for freight forwarders, 3PLs, and transportation networks.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">On-Time</div>
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Tracking</p>
            </div>
            <div className="text-center md:text-left">
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Logistics Capabilities</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">From dispatch to data entry, we keep your fleet and freight moving efficiently.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Phone, title: "Dispatch Support", desc: "24/7 driver coordination, load assignment, and issue resolution." },
              { icon: FileText, title: "Waybill & Data Entry", desc: "Digitizing BOLs, invoices, and shipping manifests with high accuracy." },
              { icon: Globe, title: "Track & Trace", desc: "Real-time shipment monitoring and exception management." },
              { icon: ClipboardList, title: "Brokerage Support", desc: "Rate negotiation, carrier sourcing, and load board management." },
              { icon: CheckCircle2, title: "Claims Processing", desc: "Handling OS&D claims and insurance documentation." },
              { icon: CheckCircle2, title: "Carrier Vetting", desc: "Onboarding and compliance checks for new carriers." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Visibility Focus</h4>
               <p className="text-white/60 font-medium">We ensure every load is tracked and every document is filed, giving you total supply chain visibility.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               { icon: Box, name: "3PLs" },
               { icon: Truck, name: "Trucking Fleets" },
               { icon: Anchor, name: "Freight Fwders" },
               { icon: Navigation, name: "Last Mile" },
               { icon: Container, name: "Warehouses" }
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            ...
            <p className="text-slate-500 text-xl font-medium">Efficient onboarding for complex logistics workflows.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Workflow Map', desc: 'Analyzing your TMS usage and dispatch protocols.', icon: MapPin },
              { step: '02', title: 'Driver Sync', desc: 'Training staff on communication with your fleet.', icon: Truck },
              { step: '03', title: 'Tracking Setup', desc: 'Establishing 24/7 monitoring schedules.', icon: Globe },
              { step: '04', title: 'Exception Mgmt', desc: 'Defining SOPs for delays and incidents.', icon: Settings2 }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Smart <br/><span className="text-[#E61739]">Logistics.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    We use AI to optimize routes, extract data from documents, and predict delays, keeping your supply chain ahead of the curve.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "Route Optimization", desc: "AI monitoring of routes to suggest efficiencies." },
                       { title: "Document OCR", desc: "Automated extraction of data from BOLs and invoices." },
                       { title: "Delay Prediction", desc: "Predictive alerts for potential shipment delays based on weather and traffic." },
                       { title: "Automated Updates", desc: "Sending status updates to customers without human intervention." }
                     ].map((feat, idx) => (
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-xl font-medium max-w-3xl mx-auto mb-10">Cost-effective roles for logistics operations.</p>
          ...
          {pricingModel === 'outcomes' ? (
            <div className="grid md:grid-cols-3 gap-6 items-start animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { 
                  name: "Dispatch Desk", 
                  price: "$2,500", 
                  desc: "24/7 fleet coordination.", 
                  features: ["Load Assignment", "Driver Communication", "Issue Resolution", "SLA Monitoring"], 
                  highlight: false 
                },
                { 
                  name: "Track & Trace", 
                  ...
                  features: ["Live Tracking Updates", "Exception Management", "Customer Notifications", "Delivery Confirmation"], 
                  highlight: true, 
                  badge: "End-to-End" 
                },
                { 
                  name: "Data Entry Pulse", 
                  price: "$1,800", 
                  desc: "High-volume digitization.", 
                  features: ["BOL/Waybill Entry", "Invoice Processing", "Manifest Digitization", "99% Accuracy Guarantee"], 
                  highlight: false 
                }
              ].map((plan, i) => (
                <div key={i} className={`p-10 rounded-[3.5rem] relative transition-all ${plan.highlight ? 'bg-slate-900 text-white shadow-2xl scale-105 border-0' : 'bg-white border border-slate-100 shadow-sm hover:shadow-xl'}`}>
                  ...
                  <button onClick={() => setView('contact')} className={`w-full py-4 rounded-[2rem] font-bold text-lg transition-all ${plan.highlight ? 'bg-[#ad1457] text-white hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] shadow-xl' : 'bg-slate-900 text-white hover:bg-black'}`}>
                    {plan.name === "Track & Trace" ? "Request Custom Quote" : "Request Plan"}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { role: "Dispatcher", price: "$2,000", focus: "Ops", focusIcon: Phone, desc: "Driver coordination and load assignment." },
                { role: "Data Entry Clerk", price: "$1,500", focus: "Admin", focusIcon: FileText, desc: "Waybill entry and document management." },
                { role: "Track & Trace", price: "$1,700", focus: "Support", focusIcon: Globe, desc: "Shipment monitoring and customer updates." },
                { role: "Broker Support", price: "$2,200", focus: "Sales", focusIcon: ClipboardList, desc: "Rate negotiation and carrier vetting." }
              ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                ...
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Need After-Hours Support?</h4>
                   <p className="text-sm text-slate-500 font-medium">Our teams can cover nights and weekends to keep your fleet moving.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: Truck, title: "Industry Veterans", desc: "Experience with TMS platforms like McLeod, MercuryGate, and Samsara." },
              { icon: Globe, title: "Round-the-Clock", desc: "Operations that never sleep, keeping your fleet moving 24/7." },
              { icon: Activity, title: "Scalable Teams", desc: "Easily scale your support team during peak shipping seasons." },
              { icon: Settings2, title: "Process Driven", desc: "Strict adherence to SOPs for consistent service delivery." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI logistics support team delivering AI-managed supply chain operations" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Accelerate Your <br/><span className="text-shine-red">Supply Chain.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our logistics operations specialists.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#ad1457] text-white rounded-[2rem] font-bold text-xl hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request Logistics Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
