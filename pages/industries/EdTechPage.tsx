...
import { ArrowRight, GraduationCap, Users, Settings, CheckCircle2, MessageSquare, BookOpen, Video, MessageCircle, UserCheck, FileCheck, School, Library, BrainCircuit, Activity, Monitor, Globe } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_EDTECH_HERO as HERO_IMG, IMG_EDTECH_TEAM } from '../../data';

export const EdTechPage = ({ setView }: { setView: (v: ViewType) => void }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-powered EdTech operations and student support solutions" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="EdTech Operations" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Student Success</span><br/>
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Scalable support, enrollment ops, and LMS management for online learning platforms.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Student Retention</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">High Vol</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Ticket Mgmt</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">99.9%</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">LMS Uptime</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">4.9/5</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Support CSAT</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Learning Services</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">Supporting the entire student lifecycle, from enrollment to graduation.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Users, title: "Student Success", desc: "Onboarding, retention outreach, and course progress monitoring." },
              { icon: Settings, title: "Technical Support", desc: "Troubleshooting login, video playback, and assignment submission issues." },
              { icon: UserCheck, title: "Enrollment Ops", desc: "Processing applications, verifying documents, and managing admissions." },
              { icon: CheckCircle2, title: "Content QA", desc: "Reviewing course materials for errors and formatting consistency." },
              { icon: FileCheck, title: "Grading Assist", desc: "Supporting instructors with grading and feedback on assignments." },
              { icon: MessageSquare, title: "Community Mod", desc: "Managing student forums and peer-to-peer groups." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Pedagogical Focus</h4>
               <p className="text-white/60 font-medium">Teams that understand the learning journey and provide support that encourages student success.</p>
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               ...
               { icon: Monitor, name: "Bootcamps" },
               { icon: Library, name: "K-12 Platforms" },
               { icon: Users, name: "Corporate L&D" },
               { icon: Globe, name: "Language Apps" }
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Learning Ops Flow.</h2>
            <p className="text-slate-500 text-xl font-medium">Integrating seamless support into the learning experience.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Platform Sync', desc: 'Integration with Canvas, Blackboard, or custom LMS.', icon: Settings },
              { step: '02', title: 'Training', desc: 'Educating agents on your curriculum and support protocols.', icon: BookOpen },
              { step: '03', title: 'Peak Scale', desc: 'Ramping up team size for semester starts and exam periods.', icon: Activity },
              { step: '04', title: 'Retention', desc: 'Implementing proactive loops to keep students engaged.', icon: Users }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Smart <br/><span className="text-[#E61739]">Education.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    AI enhances the learning experience by automating routine queries and flagging at-risk students for intervention.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "FAQ Chatbots", desc: "Instant answers for common course and administrative questions." },
                       { title: "Engagement Monitoring", desc: "Tracking login activity to identify students who may be falling behind." },
                       { title: "Auto-Grading Assist", desc: "AI tools to help grade objective assessments and quizzes." },
                       { title: "Personalized Nudges", desc: "Automated reminders for deadlines and course milestones." }
                     ].map((feat, idx) => (
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#E61739] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     ...
                     <div className="text-[10px] font-black uppercase tracking-widest opacity-80">Engagement Tracking</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">Flexible EdTech Plans.</h2>
            <p className="text-slate-500 text-xl font-medium max-w-3xl mx-auto mb-10">Scaling your learning operations without the headcount friction.</p>
          ...
          {pricingModel === 'outcomes' ? (
            <div className="grid md:grid-cols-3 gap-6 items-start animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { 
                  ...
                  price: "$2,100", 
                  desc: "Onboarding & Retention focus.", 
                  features: ["Welcome sequences", "At-risk monitoring", "Course progress tracking", "Weekly outcome reports"], 
                  highlight: false 
                },
                { 
                  name: "Enrollment Ops", 
                  price: "Custom", 
                  desc: "Full admissions management.", 
                  features: ["Application processing", "Document verification", "Lead qualification", "CRM integration"], 
                  highlight: true, 
                  badge: "End-to-End" 
                },
                { 
                  name: "Grading Assist", 
                  price: "$1,800", 
                  desc: "Assessment support unit.", 
                  features: ["Objective grading", "Feedback drafting", "Rubric adherence", "24h turnaround"], 
                  highlight: false 
                }
              ].map((plan, i) => (
                <div key={i} className={`p-10 rounded-[3.5rem] relative transition-all ${plan.highlight ? 'bg-slate-900 text-white shadow-2xl scale-105 border-0' : 'bg-white border border-slate-100 shadow-sm hover:shadow-xl'}`}>
                  ...
                  <button onClick={() => setView('contact')} className={`w-full py-4 rounded-[2rem] font-bold text-lg transition-all ${plan.highlight ? 'bg-[#E61739] text-white hover:bg-[#c51431] shadow-xl' : 'bg-slate-900 text-white hover:bg-black'}`}>
                    {plan.name === "Enrollment Ops" ? "Request Custom Quote" : "Request Plan"}
                  </button>
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {[
                { role: "Success Coach", price: "$2,000", focus: "Retention", focusIcon: Users, desc: "Guiding students through their learning journey." },
                { role: "Tech Support", price: "$1,900", focus: "Ops", focusIcon: Settings, desc: "Resolving LMS and access issues." },
                { role: "Enrollment Spec", price: "$1,800", focus: "Sales", focusIcon: UserCheck, desc: "Managing new student applications and inquiries." },
                { role: "Course Admin", price: "$1,700", focus: "Content", focusIcon: BookOpen, desc: "Updating course materials and managing schedules." }
              ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E61739] shadow-sm"><Video size={24} /></div>
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Need Live Proctoring?</h4>
                   <p className="text-sm text-slate-500 font-medium">Secure exam monitoring with trained proctors.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: BookOpen, title: "Education DNA", desc: "Teams that understand the pedagogical journey and student needs." },
              { icon: Activity, title: "Seasonal Flex", desc: "Scale up support for enrollment periods and new semesters." },
              { icon: Settings, title: "LMS Experts", desc: "Familiarity with Canvas, Blackboard, Moodle, and other platforms." },
              { icon: Users, title: "Student Centric", desc: "Focus on retention and positive learning outcomes." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={IMG_EDTECH_TEAM} alt="KDCI EdTech support team delivering AI-managed educational operations" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Scale Your <br/><span className="text-shine-red">Student Success.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our EdTech operations specialists.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#E61739] text-white rounded-[2rem] font-bold text-xl hover:bg-[#c51431] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request EdTech Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
