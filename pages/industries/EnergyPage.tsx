...
import { ArrowRight, Flame, AlertTriangle, FileText, UserPlus, BarChart3, Sun, MapPin, Zap, BrainCircuit, CheckCircle2, Factory, Phone, Activity, Settings2 } from 'lucide-react';
import { ViewType } from '../../types';
import { Breadcrumbs } from '../../components/Shared';
import { IMG_ENERGY_HERO as HERO_IMG, IMG_ENERGY_TEAM as TEAM_IMG } from '../../data';

export const EnergyPage = ({ setView }: { setView: (v: ViewType) => void }) => {
  return (
    <div className="min-h-screen bg-white">
      {/* 1. Hero Section */}
      <section className={`relative bg-[#020202] overflow-hidden pt-48 pb-32 md:pb-40`}>
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={HERO_IMG} alt="KDCI AI-managed energy sector operations and customer support" className="w-full h-full object-cover opacity-20 object-center" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Energy & Utilities" parent={{ name: 'Solutions', view: 'solutions-hub' }} />
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-6 md:mb-10 tracking-tight leading-[0.95] drop-shadow-2xl">
            <span className="text-shine-white">Grid Reliability</span><br/>
            <span className="text-[#E61739]">Utility Ops.</span>
          </h1>
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-white/60 font-medium leading-relaxed mb-10 md:mb-16 px-4">
            Customer service and field dispatch support for solar, renewable, and utility providers.
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white/5 border-t border-white/10 backdrop-blur-md py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 md:gap-x-20 lg:gap-x-28 items-center text-white">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Dispatch</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">99%</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Uptime Support</p>
            </div>
            <div className="text-center md:text-left">
              <div className="text-xl md:text-2xl font-black mb-1 text-center">Field</div>
              <p className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest">Synced</p>
            </div>
            <div className="text-center md:text-left">
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="text-[#E61739] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Utility Services</div>
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">What We Do.</h2>
            <p className="text-slate-500 text-xl max-w-3xl mx-auto font-medium">Critical support infrastructure for energy providers and green tech companies.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: AlertTriangle, title: "Outage Reporting", desc: "Handling emergency calls and dispatching field crews during service interruptions." },
              { icon: FileText, title: "Solar Permitting", desc: "Managing interconnection applications, permit paperwork, and zoning approvals." },
              { icon: UserPlus, title: "Customer Enrollment", desc: "Onboarding new accounts, managing plan changes, and service transfers." },
              { icon: BarChart3, title: "Meter Data Mgmt", desc: "Processing usage data, validating reads, and handling billing exceptions." },
              { icon: Phone, title: "Field Dispatch", desc: "Coordinating technician schedules and communicating with crews in the field." },
              { icon: Activity, title: "Billing Support", desc: "Answering billing inquiries and processing payments for utility customers." }
            ].map((s, i) => (
          ...
          <div className="mt-12 p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
             ...
             <div className="relative z-10">
               <h4 className="text-2xl font-bold mb-2">Crisis Ready</h4>
               <p className="text-white/60 font-medium">Our teams are prepared for high-volume surge events, storms, and critical infrastructure needs.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
             {[
               { icon: Sun, name: "Solar Providers" },
               { icon: Factory, name: "Utility Companies" },
               { icon: Zap, name: "Grid Operators" },
               { icon: Activity, name: "Green Tech" },
               { icon:  Zap, name: "EV Charging" } // Reusing Zap if Battery not available or import Battery
             ].map((type, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            ...
            <p className="text-slate-500 text-xl font-medium">Deploying your energy support team.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-12 relative">
            <div className="hidden md:block absolute top-[2.75rem] left-[10%] right-[10%] h-[1px] bg-slate-100"></div>
            {[
              { step: '01', title: 'Grid Map', desc: 'Understanding your service territory and infrastructure.', icon: MapPin },
              { step: '02', title: 'Crew Sync', desc: 'Integrating with your field dispatch software.', icon: Settings2 },
              { step: '03', title: 'Alert Setup', desc: 'Configuring emergency response and notification protocols.', icon: AlertTriangle },
              { step: '04', title: 'Crisis Protocol', desc: 'Drills and preparation for storm season surges.', icon: Flame }
            ].map((s, idx) => (
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8 leading-tight">Smart <br/><span className="text-[#E61739]">Energy Ops.</span></h2>
                  <p className="text-xl text-white/40 mb-12 leading-relaxed font-medium">
                    AI assists in predicting outages, balancing loads, and automating routine customer queries.
                  </p>
                  
                  <div className="space-y-8">
                     {[
                       { title: "Outage Prediction", desc: "Analyzing weather and grid data to forecast potential issues." },
                       { title: "Load Balancing", desc: "AI analysis of usage patterns to optimize grid distribution." },
                       { title: "Chatbots", desc: "Instant answers for billing and service status inquiries." },
                       { title: "Smart Meter Reading", desc: "Automated validation of meter data for billing accuracy." }
                     ].map((feat, idx) => (
               ...
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-[#E61739] p-8 rounded-[3rem] shadow-2xl hidden md:block">
                     ...
                     <div className="text-[10px] font-black uppercase tracking-widest opacity-80">Grid Monitoring</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-32 bg-[#F5F5F7] rounded-t-[5rem]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-500 text-xl font-medium">Cost-effective roles for energy operations.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { role: "Dispatcher", price: "$2,100", focus: "Field", focusIcon: Phone, desc: "Coordinating crews and handling emergency calls." },
              { role: "Permit Coord", price: "$1,900", focus: "Admin", focusIcon: FileText, desc: "Processing solar and construction permits." },
              { role: "Support Agent", price: "$1,800", focus: "Customer", focusIcon: UserPlus, desc: "Billing inquiries and service requests." },
              { role: "Data Analyst", price: "$2,200", focus: "Data", focusIcon: BarChart3, desc: "Analyzing usage patterns and grid data." }
            ].map((plan, i) => (
          ...
          <div className="mt-12 p-8 bg-white/60 backdrop-blur-md rounded-[3rem] border border-dashed border-slate-300 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex gap-6 items-center">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E61739] shadow-sm"><AlertTriangle size={24} /></div>
                <div>
                   <h4 className="text-lg font-bold text-slate-900">Emergency Response?</h4>
                   <p className="text-sm text-slate-500 font-medium">Surge teams ready for storm seasons and critical events.</p>
                </div>
             </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: Flame, title: "Renewable Focus", desc: "Expertise in the growing solar and green energy sector." },
              { icon: Zap, title: "Crisis Ready", desc: "Prepared for high-volume surge events." },
              { icon: Factory, title: "Utility Scale", desc: "Experience handling large-scale utility customer bases." },
              { icon: Activity, title: "Data Driven", desc: "Leveraging data for grid optimization and efficiency." }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#020202] rounded-[5rem] overflow-hidden relative border border-white/5 px-6 py-20 md:p-24 text-center group">
           <div className="absolute inset-0 z-0">
              <img loading="lazy" src={TEAM_IMG} alt="KDCI energy industry support team delivering AI-managed operations" className="w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
           </div>
           ...
           <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-tight">Power Your <br/><span className="text-shine-red">Operations.</span></h2>
              <p className="text-xl md:text-2xl text-white/60 mb-12 font-medium leading-relaxed">Book a consultation with our energy operations specialists.</p>
              <button onClick={() => setView('contact')} className="px-14 py-6 bg-[#E61739] text-white rounded-[2rem] font-bold text-xl hover:bg-[#c51431] transition-all glow-red shadow-2xl flex items-center justify-center gap-4 group mx-auto">
                 Request Energy Quote <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
           </div>
        </div>
      </section>
