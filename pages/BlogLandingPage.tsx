...
export const BlogLandingPage = ({ setView }: { setView: (v: ViewType) => void }) => {
  ...
  const categories = ["All", "AI Operations", "Future of Work", "Engineering", "Case Studies"];
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* 1. Hero Section (Matched to CaseStudiesPage) */}
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Filters (Inline to match CaseStudies layout cleanliness) */}
