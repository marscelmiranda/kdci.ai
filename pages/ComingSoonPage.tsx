...
export const ComingSoonPage = ({ setView }: { setView: (v: ViewType) => void }) => {
  return (
    <div className="min-h-screen bg-[#020202] flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 w-[600px] h-[600px] bg-[#ad1457]/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] bg-[#ad1457]/4 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 text-center max-w-xl mx-auto">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#ad1457]/15 border border-[#E61739]/25 text-[#E61739] text-[10px] font-black uppercase tracking-widest mb-8">
          <Clock size={11} />
          In Development
        </div>
        ...
        <div className="mt-14 pt-10 border-t border-white/[0.07]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              ...
              { label: 'AI in Customer Service', view: 'customer-support' },
