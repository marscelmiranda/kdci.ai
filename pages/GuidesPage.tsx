...
import { ArrowRight, X, Plus, ChevronDown, BrainCircuit, Users, Layers, FileText, BarChart3, Palette, Settings, Globe, BookOpen, Search } from 'lucide-react';
...
export const GuidesPage = ({ setView }: { setView: (v: ViewType) => void }) => {
  ...
  const filtered = guides.filter(g => {
    ...
    const searchOk = q === '' || g.title.toLowerCase().includes(q) || g.desc.toLowerCase().includes(q);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#020202] overflow-hidden pt-36 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Guides & Playbooks" parent={{ name: 'Insights', view: 'insights' }} />
          <div className="mt-6">
            ...
            <div className="relative max-w-lg mx-auto mt-8">
              ...
              <input
                type="text"
                placeholder="Search guides, playbooks, or topics..."
                value={searchQuery}
                ...
                return (
                  <div key={guide.id} onClick={() => setView('contact')}
                    ...
                    <div className="relative h-44 overflow-hidden shrink-0">
                      <img loading="lazy" src={guide.thumb} alt={guide.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
