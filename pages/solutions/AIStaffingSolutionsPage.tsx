...
import IMG_AI_STAFFING_CONTACT from '@/attached_assets/contact-us-ai-staffing_1779919615629.webp';
      ...
      <section className="py-24 bg-[#F9F9F9] border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-slate-900 mb-6">AI staffing and professional services<br />built for your industry.</h2>
