    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex font-sans">
      ...
      <main className="flex-grow p-8 md:p-12 overflow-y-auto">
        <div className="flex justify-between items-center mb-10">
          ...
          <button className="px-6 py-3 bg-[#ad1457] hover:bg-[#F5F5F7] hover:text-[#ad1457] hover:ring-1 hover:ring-[#ad1457] text-white rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-lg glow-red">
