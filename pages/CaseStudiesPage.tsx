...
import { ArrowRight, Smartphone, Globe, Building2, ShoppingCart, Activity, Plus, X, ChevronDown, Truck, Scale, GraduationCap, Plane, Megaphone, Car, Search } from 'lucide-react';
...
export const CaseStudiesPage = ({ setView, onStudyClick }: { setView: (v: ViewType) => void; onStudyClick?: (id: string, slug?: string) => void }) => {
  ...
  const filtered = allStudies.filter(cs => {
    ...
    const searchOk = q === '' || cs.title.toLowerCase().includes(q) || cs.desc.toLowerCase().includes(q);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#020202] overflow-hidden pt-36 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <Breadcrumbs setView={setView} currentName="Case Studies" parent={{ name: 'Insights', view: 'insights' }} />
          <div className="mt-6">
